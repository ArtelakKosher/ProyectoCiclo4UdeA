  ...
  return (
    <Helmet title="Inicio">
      <section>
        ...
        <Container>
          <Row>
            ...
            <Col lg="6" md="6" style={{display: "flex", justifyItems: "center", alignItems: "center"}}>
      ...
      <section className="why__choose-us">
        ...
        <Container>
          <Row>
            <Col lg="6" md="6" style={{display: "flex", justifyItems: "center", alignItems: "center", padding: "40px"}}>
                ...
                <ListGroup className="mt-4">
                  <ListGroupItem className="border-0 ps-0">
                    ...
                    <p className="choose__us-desc">
                      Nuestros productos no contienen colorantes ni conservantes artificiales.
                    </p>
                  </ListGroupItem>
